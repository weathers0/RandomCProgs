...
::TODO: Find out what Qunused-arguments means/does

::Combine .o files into single .exe
gcc -ggdb3 -O0 -std=c11 -Wall -Werror -Wextra -Wno-sign-compare -Wno-unused-parameter -Wno-unused-variable -Wshadow -o manyFib main.o helper.o -lm
