//Code for functions so main file looks sexy
...
void watermark(FILE *out) {
    ...
    //Print the world baby
    fprintf(out, "|------------------------------------------------------------------------|\n");
    fprintf(out, "| This was generated on %s by Gushing Grandmothers & co                  |\n", s);
    fprintf(out, "| All fibonacci numbers are now registered trademarks of gushing         |\n");
    fprintf(out, "| grandmothers & co,you fucking nonce. under Gushing Grandmothers & co   |\n");
    fprintf(out, "| terms and conditions great Algorithms and all associated registered    |\n");
    fprintf(out, "| corporations because I! said so. Any attempt to use or pirate these    |\n");
    fprintf(out, "| numbers and or application will result in prosecution and harsh legal action. haha get fucked formatting   |\n");
    fprintf(out, "|------------------------------------------------------------------------|\n");
}
...
char* add(char *a, char *b) {
    ...
    if (c == NULL)
    {
        printf("don't worry pog man, get more ram and come back when you're a mister meme\n");
        exit(1);
    }
    c[0] = '0';
